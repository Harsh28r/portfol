  ...
  schools: [
    {
      ...
      logo: require("./assets/images/edu1.png"),
  ...
  experience: [
    {
      ...
      company: "Mobbana",
      companylogo: require("./assets/images/mobbana-medium.png"),
...
const bigProjects = {
  ...
  projects: [
    {
      image: require("./assets/images/Food Fire Logo.png"),
    ...
    },
    {
      ...
      projectName: "Sparks",
      projectDesc: "Designed a user-friendly structure using Figma",
      footerLink: [
        {
          name: "Visit Website",
  ...
  achievementsCards: [
    {
      ...
      image: require("./assets/images/mobbana-logo.png"),
      imageAlt: "BB",
      footerLink: [
        {
          name: "Certification",
    ...
    },
    {
      ...
      image: require("./assets/images/logo-flipkart-png-flipkart-logo-vector-300.png"),
      imageAlt: "flip Logo",
      footerLink: [
        {
          name: "certificate",
    ...
    },
    {
      ...
      image: require("./assets/images/JP-Morgan-Chase-Logo-120x67.png"),
      imageAlt: "jpLogo",
      footerLink: [
